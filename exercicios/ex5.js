...
// O resultado será: 0.30000000000000004. Outra coisa importante de observar, é o fato que o ponto é utilizado no lugar da vírgula e vice versa.
...
function numerosQuebrados(numeroQuebrado = 0.30000000000000004) {
    // ou: return `R$ ${valorDecimal.toFixed(2).toString().replace(".", ",")}`
    return numeroQuebrado.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL'})
}
console.log(numerosQuebrados(0.1 + 0.2))