...
function calcularSalario(quantidadeHorasTrabalhadas, ganhoPorHora) {
    const salario = quantidadeHorasTrabalhadas * ganhoPorHora
    return console.log(`Salário igual a R$ ${salario.toFixed(2)}`)
}
